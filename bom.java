...
public class bom extends HttpServlet
{
	...
	try
	{
		...
		String qry="select title,type,artist1,artist2,s1,s2,rate from music where rownum<11 order by nocs desc";
		rs=stmt.executeQuery(qry);
		pw.println("<pre><b><font size=6>"+"\t\t\t"+"<u>"+"BEST MUSIC OF MELLANNIUM\'S"+"</pre></u></b></font>");
