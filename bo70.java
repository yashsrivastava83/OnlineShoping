...
public class bo70 extends HttpServlet
{
	...
	try
	{
		...
		String qry="select title,type,artist1,artist2,s1,s2,rate from music where to_char(dor,'yy') in (70,71,72,73,74,75,76,77,78,79)";
		rs=stmt.executeQuery(qry);
		pw.println("<pre><b><font size=6>"+"\t\t\t"+"<u>"+"BEST MUSIC OF 70\'S"+"</pre></u></b></font>");
