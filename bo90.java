...
public class bo90 extends HttpServlet
{
	...
	try
	{
		...
		String qry="select title,type,artist1,artist2,s1,s2,rate from music where to_char(dor,'yy') in (90,91,92,93,94,95,96,97,98,99)";
		rs=stmt.executeQuery(qry);
		pw.println("<pre><b><font size=6>"+"\t\t\t"+"<u>"+"BEST MUSIC OF 90\'S"+"</pre></u></b></font>");
