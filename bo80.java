...
public class bo80 extends HttpServlet
{
	...
	try
	{
		...
		String qry="select title,type,artist1,artist2,s1,s2,rate from music where to_char(dor,'yy') in (80,81,82,83,84,85,86,87,88,89)";
		rs=stmt.executeQuery(qry);
		pw.println("<pre><b><font size=6>"+"\t\t\t"+"<u>"+"BEST MUSIC OF 80\'S"+"</pre></u></b></font>");
