...
public class artsh extends HttpServlet
{
	...
	try
	{
		...
		String alph=req.getParameter("artsrh");
		String qry="select title,type,artist1,artist2,s1,s2,rate from music where artist1 ='"+ alph+
		"' or artist2='"+alph+"'";
		rs=stmt.executeQuery(qry);
		pw.println("<center><u>"+"<font size=5><b>"+" ARTIST "+alph.toUpperCase() +"</b></u></center></font>");
		...
		pw.println("<pre><label>		Item type:        </label><input type=text name=txtr</label>");
