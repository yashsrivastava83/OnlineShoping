...
public class ttalbm extends HttpServlet
{
	...
	try
	{
		...
		String qry="select title,aritst1,artist2,s1,s2,rate from music where type='a' and rownum<11 order by nocs desc ";
		rs=stmt.executeQuery(qry);
		pw.println("<br>");
		pw.println("<pre><b><font size=6>"+"\t\t\t"+"<u>"+"TOP TEN ALBUMS"+"</pre></u></b></font>");
		...
		pw.println("<pre><label>		Item name:        </label><input type=text name=txtr></pre>");
