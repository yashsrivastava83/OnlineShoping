...
public class alphorder extends HttpServlet
{
	...
	try
	{
		...
		String alph=req.getParameter("alphsrh");
		String qry="select title,author,pname,subject,rate  from books where title like '"+alph+"%'";
		ResultSet rs=stmt.executeQuery(qry);
		pw.println("<pre><b><font size=6>"+"\t\t\t"+"<u>"+"ALPHBATICAL LIST OF BOOKS"+"</pre></u></b></font>");
		...
		t=rs.getString(5);
		s=s.concat(t);
		pw.println("<pre><option>"+s+"</option><br></pre>");
		}
